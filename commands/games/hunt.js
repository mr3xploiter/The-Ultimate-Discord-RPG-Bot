...
module.exports = {
  data: new SlashCommandBuilder().setName("hunt").setDescription("Hunt for items (30 minute cooldown)"),
  cooldown: 5,
  ...
  async execute(interaction, client, user) {
    ...
    if (scenario.reward) {
      ...
      user.updateQuestProgress("collect", "any_item", 1)
      user.updateQuestProgress("collect", foundItem, 1)
