...
// Add likes and dislikes arrays to the user schema
const userSchema = new mongoose.Schema({
  ...
  profile: {
    ...
    likes: {
      type: [String], // Array of userIds who liked this profile
      default: [],
    },
    dislikes: {
      type: [String], // Array of userIds who disliked this profile
      default: [],
    },
    lastVoteTime: {
      type: Map,
      of: Date,
      default: new Map(), // Map of userId -> last vote time
    },
  },
